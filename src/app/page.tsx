        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Slot Fox helps you manage appointments, reduce no-shows, and provide a seamless booking experience for your clients.
            </p>
      ...
      <div id="features" className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Slot Fox provides all the tools you need to manage your appointments efficiently and professionally.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:order-1 md:mt-0">
            <p className="text-center text-xs leading-5 text-gray-500">
              &copy; {new Date().getFullYear()} Slot Fox. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
