    ...
    <div className="space-y-3">
      ...
      >
        <svg className="h-5 w-5" aria-hidden="true" viewBox="0 0 24 24">
          ...
          />
          <path
            d="M12.0004 24C15.2354 24 17.9504 22.935 19.9454 21.095L16.0804 18.095C15.0054 18.82 13.6204 19.245 12.0004 19.245C8.87043 19.245 6.21543 17.135 5.27045 14.29L1.28046 17.385C3.25546 21.31 7.31048 24 12.0004 24Z"
            fill="#34A853"
          />
        </svg>
        Sign in with Google
